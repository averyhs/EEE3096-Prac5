...
def print_adc():
    ...
    runtime = int(time() - starttime) # calculate runtime & cast to int
    ldr_voltage = 3.3 - chan.voltage # calculate LDR voltage
    print(runtime,"s\t",chan.value,"\t\t",ldr_voltage," V",sep="") # print ADC value
